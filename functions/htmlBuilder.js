                ...
                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" width="600" class="es-content-body">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                            <td align="center" class="es-p10b"><h1 class="es-m-txt-c" style="font-size:46px;line-height:46px">Verificação de Email</h1></td>
                            </tr>
                        </table></td>
                        </tr>
                    </table></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" style="border-left:2px dashed #cccccc;border-right:2px dashed #cccccc;border-top:2px dashed #cccccc;border-bottom:2px dashed #cccccc;border-radius:5px;border-collapse:separate">
                            <tr>
                            <td align="center" class="es-p20t es-p20r es-p20l"><h2 class="es-m-txt-c">Seu código é:</h2></td>
                            </tr>
                            <tr>
                            <td align="center" class="es-p10t es-p20b es-p20r es-p20l"><h1 class="es-m-txt-c" style="color:#666666"><strong>${code}</strong></h1></td>
                            </tr>
                        </table></td>
                        </tr>
                    </table></td>
